...
export default function LessonPlan() {
  ...
  const handleContinue = () => {
    updateDirection(1);
    router.push("/personalize"); // Towards personalization
  };
      ...
      >
        ...
        <div className="w-full mt-auto pb-4 pt-4">
          <motion.button
            ...
            className={`w-full h-14 bg-[#5032F5] text-white rounded-full text-[18px] font-bold transition-all shadow-md ${!lessonsPerWeek ? 'opacity-50 cursor-not-allowed' : 'opacity-100 shadow-purple-500/20'
              }`}
