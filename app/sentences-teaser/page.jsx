...
export default function SentencesTeaser() {
  ...
  const isReady = useImagePreload("/mom.webp");
    ...
    <div className="w-full flex flex-col items-center min-h-screen relative overflow-x-clip">
      ...
      >
        ...
        <div className="text-[16px] text-start text-black font-normal mb-4 px-2 leading-relaxed">
          In early lessons, your child learns to blend carefully chosen words into sentences. Step by step, they&apos;ll build confidence — and <span className="font-bold">before you know it, they&apos;ll read their first sentence.</span>
        </div>
