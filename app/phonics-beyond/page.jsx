      ...
      >
        ...
        <div className="w-full flex flex-col items-start px-2">
          ...
          <div className="text-[16px] text-[#221750] font-medium leading-relaxed opacity-90">
            <p className="mb-6">
              LetterSchool guides your child through letter formation, spelling, and phonics — no preparation or extra materials needed.
            </p>
            <p>
              LetterSchool is phonics-based and covers all the core building blocks: letter formation, phonemic awareness, spelling, and number formation.
            </p>
          </div>
        </div>
      </motion.main>
