...
export default function FirstTimer() {
  ...
  const isReady = useImagePreload("/doodle.webp");
    ...
    <div className="w-full flex flex-col items-center min-h-screen relative overflow-x-clip">
      ...
      >
        ...
        <div className="text-[16px] text-start text-black font-normal mb-4 px-2 leading-relaxed">
          In the first lessons, your child will learn how to recognize letters and the sound they make to <span className="font-bold">build a strong reading foundation.</span> Our fun ABC song, Hungry Cloud game will ensure your child is ready for the next steps.
        </div>

        <div className="bg-[#FFECFF] border border-[#FBA0FF] rounded-[12px] py-2 px-6 mb-8 text-start w-full">
